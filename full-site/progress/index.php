...
<body>
  ...
  <section class="third light">
    ...
    <div class="wrapper">
      ...
      <h2 class="subheader">
        <p><span id="building_status" >Статус робіт:</span><span class="normal normal--1">Закінчено цегляну кладку на 12-16 поверхах, розпочато - на 17-20 поверхах. Монолітні роботи: перекриття 24-25 поверхів. Вікна: триває монтаж на 15-19 поверхах. Вікна над кубом: встановлені ригелі системи. НВФ – Жилянська – до 15 поверху. ВК: стояки на15 поверху. ОВ: улаштування горизонтальної розводки на 12 поверсі. Електрика: улаштування стояків на 15 поверсі. Стяжка: тривають роботи на 12 поверсі.</span></p>
