...
<body>
  ...
  <section class="third light">
    ...
    <div class="wrapper">
      ...
      <h2 class="subheader">
        <p><span id="building_status" >Статус робіт:</span><span class="normal normal--1">Кладка: завершуються роботи на 21 поверсі, триває кладка на 22-23 поверхах. 
Моноліт: перекриття 24-25 поверхів та парапету.
Монтаж вікон: тривають роботи на 18-20 поверхах, монтаж вікон зі сторони двору. 
Вікна над кубом: змонтовані до 20-го поверху.
Навісні вентильовані фасади: тривають роботи до 15 поверху зі сторони вул. Жилянської.
Водовідвід та каналізація: встановлюються стояки до 16 поверху. 
Опалення та вентиляція: монтаж горизонтальної розводки - 16 поверх. 
Електрика: встановлюються стояки - 16 поверх. 
Стяжка: тривають роботи на 14-15 поверхах. 
