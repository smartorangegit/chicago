        ...
        <ul class="header-nav">
            <li id="mobile" class="mobile">
                <ul id="minimenu">
                    ...
                    <li class="language"><?php /*Google Tag Manager*/
                        if ($_SERVER[REQUEST_URI] != '/atmosfera/') {
                            include($_SERVER['DOCUMENT_ROOT'] . '/includes/lang_m.php');
                        } ?></li>
                    <li class="menu-close">
                    ...
                    <li><a href="/service-department/" class="separate">ДЛЯ ТИХ ХТО ПРИДБАВ</li>
