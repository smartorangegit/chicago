  ...
  <div class="wrapper flex">
    <div class="footer__item">
      <dl class="footer_column">
        <dt>About project</dt>
        <dd><a href="/en/#section-gallery">Gallery</a></dd>
        <dd><a href="/en/#section-advantages">advantages</a></dd>
				<dd><a href="/en/#section-values">Values</a></dd>
        <dd><a href="/en/#section-location">Location</a></dd>
				<dd><a href="/en/panorama/">Panorama</a></dd>
        <dd><a href="/en/progress/">Construction</a></dd>
    ...
    <div class="footer__item">
      <dl class="footer_column">
        <dt>House:</dt>
        <dd><a href="/en/choice/">Flats</a></dd>
        <!-- <dd><a href="/filter/">Фільтр выбору квартир</a></dd> -->
        <dd><a href="/en/odnokomnatnaya-kvartira/">1-room</a></dd>
        <dd><a href="/en/dvuhkomnatnaya-kvartira/">2-room</a></dd>
        <dd><a href="/en/trehkomnatnaya-kvartira/">3-room</a></dd>
				<dd><a href="/en/dvuhurovnevaya-kvartira/">Two-level app</a></dd>
        <dd><a href="/en/kvartiri-s-remontom/">Apartments with repair</a></dd>
        <dd><a href="/en/torgovie-pomescheniya/">Commercial premises</a></dd>
      </dl>
    </div>
    <div class="footer__item">
      <dl class="footer_column">
        <dt>Info:</dt>
        <dd><a href="/en/#builder">Developer</a></dd>
        <dd><a href="/en/atmosfera/">Sfera Living System</a></dd>
				<dd><a href="/en/service-department/">Those who bought</a></dd>
				<dd><a href="/en/ctc/">Client Technical Control</a></dd>
    ...
    <div class="footer__item">
      <dl class="footer_column footer_column__last">
        ...
        <dt class="second_dt">Sales department working hours:</dd>
        <dd><svg width="12" height="12"><use xlink:href="#clock"></use></svg>MON-FRI: 9.00 - 19.00</dd>
				<dd><svg width="12" height="12"><use xlink:href="#clock"></use></svg>SAT: 10.00 - 18.00</dd>
        <dd><svg width="12" height="12"><use xlink:href="#clock"></use></svg>SUN: 10.00 - 18.00</dd>
				...
				<dd><a href="#callback" class="button callback">callback</a></dd>
      </dl>
    </div>
  </div>
</section>
<footer>
    <div class="wrapper flex">
			 ...
			 <a href="/en/sitemap/" style="margin-right:16px;">
