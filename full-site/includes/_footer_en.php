	<footer>
       <div class="wrapper">
				 ...
				 <span>marketing department - marketing@riverside.net.ua</span>
				 <span><a href="/en/sitemap/" style="margin: 0 20px;"><img <?LazyLoad("/img/home-footer.svg");?> alt="sitemap" width="30px" style="margin-bottom:-3px;"></a></span>
				 <span class="smarto">
						 website development
