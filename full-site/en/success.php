		...
		<div class="section_404">
			...
			<div class="wrapper">
				<div class="one_slider">
					<p class="section_name">Thank you! </p>
					<p class="fr_1"><strong>Your application has been successfully submitted.</strong></p>
					<p class="fr_2">Manager will contact you as soon as possible</p>
