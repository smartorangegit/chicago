          ...
          <li id="mobile" class="mobile">
            <ul id="minimenu">
              <li id="miniclose" class="mobile">
                ...
                <li><a href="../../#builder" class="separate">developer</a></li>
...
<li style="text-transform:lowercase; line-height: 1.4;">sales departamen </br>(044) 49-80-400</li>
...
<?php include('../../../includes/form_reserve_en.php'); ?>
        ...
        <div class="ch-center">
          ...
          <div class="center-map">
            <div class="img_plan">
              <img src="../../../img/choice/plan10-14.svg?v=1.0" width="442px" alt="">
