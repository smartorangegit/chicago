	...
	<section class="twelfth light">
		<div class="grid clearfix">
			<figure class="effect-milo wow fadeInLeft">
				<img <?LazyLoad("/img/galll-1.jpg");?>   alt="Скляний куб із медіа-скульптурою - ЖК CHICAGO Central House"/>
				<figcaption>
					<h3>Art</h3>
					<p>
		...
		<?php/*		<div class="logo_kdd">
			...
			<div class="right-part wow fadeInRight">
				...
				<div class="docs" id="builder_documents">
					...
					<a class="galery2" href="/img/choice/doc2.jpg" rel="gal2"></a>
					<a class="maindocs galery2" id="gal2" href="/img/choice/doc3.jpg" rel="gal2" style="font-weight:bold; color:#fff;"><img <?LazyLoad("/img/choice/doc3pic.jpg");?> alt="Експертний звіт" title="Експертний звіт"></a>
					<a class="galery2" href="/img/choice/doc4.jpg" rel="gal2"></a>
					<a class="galery2" href="/img/choice/doc5.jpg" rel="gal2"></a>
					<a class="maindocs galery2" id="gal2" href="/img/choice/doc6.jpg" rel="gal2" style="font-weight:bold; color:#fff;"><img <?LazyLoad("/img/choice/doc6pic.jpg");?> alt="Договір про право користування" title="Договір про право користування"></a>
					<a class="galery2" href="/img/choice/doc7.jpg" rel="gal2"></a>
					<a class="galery2" href="/img/choice/doc8.jpg" rel="gal2"></a>
					<a class="maindocs galery2" id="gal2" href="/img/choice/doc10.jpg" rel="gal2" style="font-weight:bold; color:#fff;"><img <?LazyLoad("/img/choice/doc10pic.jpg");?> alt="Інформація з державного реєстру речових прав" title="Інформація з державного реєстру речових прав"></a>
					<a class="galery2" href="/img/choice/doc11.jpg" rel="gal2"></a>
					<a class="maindocs galery2" id="gal2" href="/img/choice/doc12.jpg" rel="gal2" style="font-weight:bold; color:#fff;"><img <?LazyLoad("/img/choice/doc12pic.jpg");?> alt="Рішення про державну реєстрацію прав" title="Рішення про державну реєстрацію прав"></a>
					<a class="galery2" href="/img/choice/doc13.jpg" rel="gal2"></a>
					<a class="maindocs galery2" id="gal2" href="/img/choice/doc14.jpg" rel="gal2" style="font-weight:bold; color:#fff;"><img <?LazyLoad("/img/choice/doc14pic.jpg");?> alt="Містобудівні умови та обмеження" title="Містобудівні умови та обмеження"></a>
					<a class="galery2" href="/img/choice/doc15.jpg" rel="gal2"></a>
					<a class="galery2" href="/img/choice/doc16.jpg" rel="gal2"></a>
					<a class="galery2" href="/img/choice/doc17.jpg" rel="gal2"></a>
					<a class="galery2" href="/img/choice/doc18.jpg" rel="gal2"></a>
...
<div class="working_hours">
		...
		<input  type="submit" value="Надіслати" class="button">
	     ...
	     <form  id="realtor-form" action="application.php" method="post" enctype="multipart/form-data" class="wrapper form clearfix" style="display: none;">
            ...
            <div class="input_wrap realtor_input_wrap">
                ...
                <span class="placeholder">Назва АН:<i>*</i></span>
            </div>
            <div class="input_wrap realtor_input_wrap">
                <input type="text" name="name" required>
                <span class="placeholder">Ім&prime;я:<i>*</i></span>
    ...
    <?//    <div class="g-recaptcha" id="reCaptcha2" data-sitekey="6Lc1XRUUAAAAAM-WkPVHbGRPXqTkfaOEaFlsqEBu"></div> */?>
        ...
        <div class="for_btn">
            <a class="button for_btn_link" href="#">Співпраця для рієлторів</a>
        </div>
    </section>
	...
	<!-- ===========modal window============ -->
	 <div class="main_overlay" style="display:none;">
		 <div class="main_modal">
			 <div class="modal_content">
				 <div class="modal_close"><img src="/img/close_w.svg" alt="" width="40"></div>
				 <h3>Отримуйте індивідуальні умови на придбання квартири!</h3>
				 <div class="modal_text">
				 Деталі у відділі продажу!
					 <!-- <a class="modal_link" >Дізнайтеся більше</a> -->
				 </div>
			 </div>
		 </div>
	 </div>
