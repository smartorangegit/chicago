...
<?php /*	<link rel="alternate" hreflang="en" href="http://chicago.kiev.ua/en/progress/" /> */ ?>
...
<body>
  ...
  <section class="third light">
    ...
    <div class="wrapper">
      ...
      <h2 class="subheader">
        <p><span>Статус робіт:</span><span class="normal normal--1">Облаштовуються вертикальні елементи 4-го поверху</span></p>
        <p><span class="plan--1">Запланований термін завершення будівництва:</span><span class="normal normal--2">&Iota;&Iota; квартал 2018 року</span></p>
			...
			<div class="status clearfix">
				<div class="status__grid grid__1">
					...
					<img src="/img/house_full.png" alt="status">
			...
			<div class="progres_web">
				<iframe src="https://macparts.kiev.ua:8402/player.html" name="restreamer-player" width="100%" height="100%" scrolling="no" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen="true"></iframe>    </div>
			</div>
  </section>
		...
		<section class="building">
			<div class="wrapper">
				<div class="content-item">
					<section id="progress-img" class="progress-img">
						<div class="wrapper">
							...
							<div class="cont-img-left">
								...
								<div class="img-item image-item--13">
										...
										<div class="img-info" style="line-height:23px;"><span style="line-height:23px;">Проводятся роботи з облаштування плити перекриття та вертикальних елементів 4-го поверху. Розпочинаються роботи з облаштування плити перекриття 5-го поверху. Завершуються роботи з облаштування ліфтової шахти на 4-му поверсі.</span></div>
											<a class="eye grouped_elements" rel="group13" href="/img/300517_0.jpg"><img src="/img/prog-eye.png" alt="eye"/></a>
                  ...
                  <div class="img-item image-item--11">
										<div class="img-name"><span>Будівельні роботи</span></div>
										...
										<div class="img-info" style="line-height:23px;"><span style="line-height:23px;">Проводятся роботи з облаштування плити перекриття між 2-м та 3-м поверхами, облаштовуються вертикальні елементи третього поверху. Проводятся роботи з облаштування ліфтової шахти на третьому поверсі.</span></div>
											<a class="eye grouped_elements" rel="group11" href="/img/20170511_0.jpg"><img src="/img/prog-eye.png" alt="eye"/></a>
									 ...
									 <div class="img-item image-item--9">
											<div class="img-name"><span>Будівельні роботи</span></div>
											...
											<div class="img-info"><span>Облаштування монолітного каркасу та залиття другого рівня паркінгу.</span></div>
												<a class="eye grouped_elements" rel="group9" href="/img/20170227_01.jpg"><img src="/img/prog-eye.png" alt="eye"/></a>
                                      ...
                                      <div class="img-item image-item--7">
											<div class="img-name"><span>Будівельні роботи</span></div>
											...
											<div class="img-info"><span>Облаштування монолітного каркасу та залиття другого рівня паркингу.</span></div>
												<a class="eye grouped_elements" rel="group7" href="/img/prog31.jpg"><img src="/img/prog-eye.png" alt="eye"/></a>
												<a class="grouped_elements" rel="group7" href="/img/prog32.jpg"></a>
												<a class="grouped_elements" rel="group7" href="/img/prog33.jpg"></a>
										</div>

										<div class="img-item image-item--5">
											<div class="img-name"><span>Будівельні роботи</span></div>
											<div class="img-date">31 січня 2017 року</div>
											<div class="img-info"><span>Облаштування монолітного каркасу та залиття другого рівня паркингу.</span></div>
												<a class="eye grouped_elements" rel="group5" href="/img/prog26.jpg"><img src="/img/prog-eye.png" alt="eye"/></a>
                  ...
                  <div class="img-item image-item--2">
										<div class="img-name"><span>Будівельні роботи</span></div>
										...
										<div class="img-info"><span>Облаштування свайного поля та армування вертикальних конструкцій цокольного поверху</span></div>
											<a class="eye grouped_elements" rel="group2" href="/img/prog14.jpg"><img src="/img/prog-eye.png" alt="eye"/></a>
                  ...
                  <div class="img-item image-item--1">
										...
										<div class="img-info"><span>Початок робіт з облаштування свайного поля та армування вертикальних конструкцій цокольного поверху</span></div>
											<a class="eye grouped_elements" rel="group1" href="/img/prog4.jpg"><img src="/img/prog-eye.png" alt="eye"/></a>
								...
								<div class="cont-img-right">
									<div class="img-item image-item--12">
											<div class="img-name"><span>Будівельні роботи</span></div>
											<div class="img-date">19 травня 2017 року</div>
											<div class="img-info" style="line-height:23px;"><span style="line-height:23px;">Проводятся роботи з облаштування плити перекриття між 2-м та 3-м поверхами, облаштовуються вертикальні елементи третього поверху. Проводятся роботи з облаштування ліфтової шахти на третьому поверсі.</span></div>
												<a class="eye grouped_elements" rel="group11" href="/img/19_05_2017/IMG_20170516_200226.jpg"><img src="/img/prog-eye.png" alt="eye"/></a>
                  ...
                  <div class="img-item image-item--10">
										<div class="img-name"><span>Будівельні роботи</span></div>
										<div class="img-date">7 березня 2017 року</div>
										<div class="img-info"><span>Облаштування монолітного каркасу та залиття другого рівня паркингу.</span></div>
											<a class="eye grouped_elements" rel="group10" href="/img/20170307_01.JPG"><img src="/img/prog-eye.png" alt="eye"/></a>
									...
									<div class="img-item image-item--8">
										<div class="img-name"><span>Будівельні роботи</span></div>
										<div class="img-date">20 лютого 2017 року</div>
										<div class="img-info"><span>Облаштування свайного поля та армування вертикальних конструкцій цокольного поверху</span></div>
										<a class="eye grouped_elements" rel="group8" href="/img/prog34.jpg"><img src="/img/prog-eye.png" alt="eye"/></a>
									...
									<div class="img-item image-item--6">
										<div class="img-name"><span>Будівельні роботи</span></div>
										<div class="img-date">07 лютого 2017 року</div>
										<div class="img-info"><span>Початок робіт з облаштування свайного поля та армування вертикальних конструкцій цокольного поверху</span></div>
										<a class="eye grouped_elements" rel="group6" href="/img/prog27.jpg"><img src="/img/prog-eye.png" alt="eye"/></a>
									...
									<div class="img-item image-item--4">
										<div class="img-name"><span>Будівельні роботи</span></div>
										<div class="img-date">23 січня 2017 року</div>
										<div class="img-info"><span>Початок робіт з облаштування свайного поля та армування вертикальних конструкцій цокольного поверху</span></div>
										<a class="eye grouped_elements" rel="group4" href="/img/prog17.jpg"><img src="/img/prog-eye.png" alt="eye"/></a>
	               	...
	               	<div class="img-item image-item--3">
										<div class="img-name"><span>Будівельні роботи</span></div>
										<div class="img-date">15 грудня 2016 року</div>
										<div class="img-info"><span>Облаштування свайного поля та армування вертикальних конструкцій цокольного поверху</span></div>
											<a class="eye grouped_elements" rel="group3" href="/img/prog9.jpg"><img src="/img/prog-eye.png" alt="eye"/></a>
