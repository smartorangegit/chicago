<?php 
$dbname="forel_chika";//Укажите имя базы днных в кавычках
$dbuser="forel_chika";//Укажите имя пользователя базы днных в кавычках
$dbpass="kfznjwqe";//Укажите пароль пользователя базы днных в кавычках
$dbhost="forel.mysql.ukraine.com.ua";//Укажите IP адрес, если MySQL сервер размещен удаленно
