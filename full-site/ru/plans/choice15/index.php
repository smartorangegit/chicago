            ...
            <ul id="minimenu">
              <li id="miniclose" class="mobile">
               <li class="language"><?php /*Google Tag Manager*/ include_once('../../../includes/lang_m.php'); ?></li>
                ...
                <li><a href="../../../../#place" class="separate">расположение</a></li>
                <li><a href="../../../../news/" class="separate">новости</a></li>
                <li><a href="../../../../#builder" class="separate">застройщик</a></li>
                <li><a href="../../../../progress/" class="separate">строительство</a></li>
                <li><a href="../../../../#contact" class="separate">связь</a></li>
            </ul>
          </li>
        </ul>
...
<li><a href="#callback" class="button callback">заказать звонок</a></li>
            ...
            <li><a href="../../../../#builder">застройщик</a></li>
            <li><a href="../../../../progress/">строительство</a></li>
        ...
        <div class="ch-center">
          <div class="center-left">
            <div class="num_level">
              <span>15</span>
              <p>этаж</p>
              <p><a class="new-app" href="/ru/choice/">Выберите этаж <span>>></span></a></p>
            </div>

          </div>
          <div class="center-map">
            <div class="img_plan">
              <img src="/img/choice/plan15.png" width="442px" alt="" class="img-15">
