  ...
  <?php /*Google Tag Manager*/ include_once('../../../includes/gtm_body.php'); ?>
    ...
    <div class="wrapper_ch2">
        <div class="ch-menu nomobile">
          <ul>
            <li><a class="imglogo"  href="../../"><img src="/img/chicago-logo.png" alt="Жилой комплекс CHICAGO Central House г. Киев" title="Жилой комплекс CHICAGO Central House г. Киев"></a></li>
...
<?php include('../../../includes/form_reserve_ru.php'); ?>
        ...
        <div class="ch-center">
          ...
          <div class="center-map">
            <div class="img_plan">
              <img src="/img/choice/plan10-14.png?v=1.0" width="442px" alt="" class="img-11-14">
              ...
              <a href="../../appart/?type=1l"><div class="drop drop--17"><div class="drop-text">1Л</div></div></a>
              <a href="../../appart/?type=2l"><div class="drop drop--18"><div class="drop-text">2Л</div></div></a>
