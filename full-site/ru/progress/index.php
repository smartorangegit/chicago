...
<body>
  ...
  <section class="third light">
    ...
    <div class="wrapper">
      ...
      <h2 class="subheader">
        <p><span>Статус работ:</span><span class="normal normal--1">Кладка: продолжаются работы на 15-19 этажах, завершены 12-14 этажа. Монолит: перекрытия 23-24 этажей. Продолжается установка ригельной системы фасада над кубом. Установка окон по периметру до 15 этажа. Устройство НПФ бежевого керамогранита со стороны ул. Жилянская. Внутренние сети ОВ, ВК: стойки 14 этаж, горизонтальная разводка - 10 этаж. Внутренние сети ЭО: стойки 14 этаж. Стяжка - окончание 9 этажа.
