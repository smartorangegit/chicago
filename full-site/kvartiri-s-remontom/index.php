...
<body>
	...
	<section class="kub remont">
		...
		<div class="kub_wrapper">
			...
			<!-- У дизайні квартири в стилі Nordic відчувається любов до кольору та нестандартних рішень. Риси скандинавського стилю простежуються в усьому: синьому та сірому відтінках стін, натуральних матеріалах, з яких виготовлені меблі та паркет.

			Оскільки напрямок Nordic поєднує характерні риси мінімалізму та екостилю, для кухні, об'єднаної з вітальнею, дизайнери обрали меблі з матовою поверхнею з сірого та світло-коричневого дерева. Щоб не перевантажувати інтер’єр зайвими компонентами та зберегти його функціональність, в шафи вбудована техніка відомого бренду:
			· посудомийна машина – BOSCH SMV24AX005,
			· духова піч – BOSCH HBN539S5,
			· варильна панель – BOSCH PKE611FP1E,
			· пральна машина – BOSCH WLG20165UA,
			· холодильник – BOSCH KIV34X20.
			Правильне поєднання кольорів у вітальні також на першому місці. Сірий та пісочний відтінки стін є вдалим фоном для м’яких меблів: двох бірюзових крісел та сірого дивану. Крім цього, в кімнаті є все необхідне для комфортного відпочинку: журнальний столик, телевізор LG LED Full HD з діагоналлю 49 дюймів, кондиціонер Сooper & HUNTER з Wi-Fi-керуванням.
			Продовженням загальної концепції інтер'єру стала спальня. Вона вийшла затишною, стильною й водночас стриманою. В кімнаті є двоспальне ліжко, тумба, комод, письмовий стіл, полиця для книг, телевізор LG LED Full HD діагоналлю 43 дюйма. Незважаючи на таку кількість меблів, кімната простора та дуже світла завдяки вікнам до підлоги.
			Для оздоблення стін в душовій кімнаті використані біла та біло-сіра плитка з орнаментом, для підлоги — плитка з фактурою дерева. Для зручності майбутніх мешканців санвузол укомплектовано душовою кабінкою, умивальником з підвісною тумбою, необхідною сантехнікою та бойлером бренду ATLANTIC. -->
			...
			<div class="remont__slider-wrap">
				<div class="remont__box-slider3">
					...
					<div class="remont__box">
						<div class="remont__img">
							<a href="/img/remont/NORDIC_BATH.jpg" data-fancybox="group2" data-caption="Дизайн квартиры в стиле Nordic" title="Дизайн квартиры в стиле Nordic">
								<img src="/img/remont/NORDIC_BATH.jpg"  alt="Дизайн квартиры в стиле Nordic" title="Дизайн квартиры в стиле Nordic">
							</a>
						</div>
						<div class="kub_text">
							<p>
			...
			<div class="remont__slider-wrap">
				<div class="remont__box-slider2">
					...
					<div class="remont__box">
						...
						<div class="kub_text">
							Основний колір — сірий, він переважає в усіх деталях. Контрастні стіни в білих і графітових відтінках доповнюють меблі — обідній стіл, стільці, обтягнуті сірою щільною тканиною, в вітальні — м'який диван, журнальний столик і два червоних крісла, які є своєрідним акцентом у кімнаті. Техніка, вбудована в шафи зі світлого дерева, представлена такими моделями:
							●	 посудомийна машина – BOSCH SMV24AX005,
							●	духова піч – BOSCH HBN539S5,
							●	варильна панель – BOSCH PKE611FP1E,
							●	пральна машина – BOSCH WLG20165UA,
					...
					<div class="remont__box">
						<div class="remont__img">
							<a href="/img/remont/MODERN_BATHROOM.jpg" data-fancybox="group1" data-caption="Дизайн квартиры в стиле Modern Glamour" title="Дизайн квартиры в стиле Modern Glamour">
								<img src="/img/remont/MODERN_BATHROOM.jpg"  alt="Дизайн квартиры в стиле Modern Glamour" title="Дизайн квартиры в стиле Modern Glamour">
							</a>
						</div>
						<div class="kub_text">
							Санвузол представлений душовою кімнатою. У ній встановлена кабінка, необхідна сантехніка, бойлер ATLANTIC, умивальник з підвісною тумбою, в якій зручно зберігати рушники та косметику. У дизайні використовуються пастельні тони, завдяки чому простір вийшов дуже теплим і світлим.
						</div>
					</div>
