                    ...
                    <ul class="news__list">
                        <!-- <li class="news__list-item">
                            <div class="news__list-item-top">
                                <div class="news__list-item-image"></div>
                                <div class="news__list-item-date_1">28 серпня 2018</div>
                                <h4 class="news__list-item-heading">Opening soon: ресторан NEGORKIY готується до відкриття</h4>
                            </div>
                            <div class="news__list-item-description">
                                <p>Ресторан NEGORKIY знаходиться на першому поверсі житлового комплексу.</p>
                            </div>
                            <div class="news__list-item-bottom">
                                ...
                                <a class="news__list-item-read-more-btn" href="#">Читати далІ</a>
                            </div>
                        </li> -->
                    </ul>
